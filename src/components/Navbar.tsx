        ...
        {links.map((l) => (
          <li key={l.to}>
            <Link
              to={l.to}
              activeOptions={{ exact: l.to === "/" }}
              activeProps={{ className: "rounded-full bg-accent px-3 py-1.5 text-xs font-medium text-accent-foreground" }}
              inactiveProps={{ className: "rounded-full px-3 py-1.5 text-xs font-medium text-muted-foreground" }}
            >
              {l.label}
            </Link>
          </li>
